<?php
	...
	define('_MN_SONGLIST_FILTER_KEYWORD','Keywords to Search');
	define('_MN_SONGLIST_FILTER_SEARCHBY','Search By');
	define('_MN_SONGLIST_FILTER_TITLE','Search by Title');
	define('_MN_SONGLIST_FILTER_LYRICS','Search by Lyrics');
	define('_MN_SONGLIST_FILTER_ARTISTANDLYRICS','Search by Title & Lyrics');
	define('_MN_SONGLIST_FILTER_CATEGORY','Filter by Category');
	define('_MN_SONGLIST_FILTER_GENRE','Filter by Genre');
	define('_MN_SONGLIST_FILTER_SINGER','Filter by Singer');
