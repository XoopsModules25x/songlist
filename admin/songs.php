        ...
        switch ($fct) {
            ...
            case 'list':
                ...
                foreach ($songsHandler->filterFields() as $id => $key) {
                    $GLOBALS['xoopsTpl']->assign(strtolower(str_replace('-', '_', $key) . '_th'), '<a href="'
                                                                                                  ...
                                                                                                  . '</a>');
                    $GLOBALS['xoopsTpl']->assign('filter_' . strtolower(str_replace('-', '_', $key)) . '_th', $songsHandler->getFilterForm($GLOBALS['filter'], $key, $GLOBALS['sort'], $GLOBALS['op'], $GLOBALS['fct']));
                }
            ...
            case 'edit':
                ...
                if (isset($_REQUEST['id'])) {
                    $songs = $songsHandler->get((int)$_REQUEST['id']);
                } else {
